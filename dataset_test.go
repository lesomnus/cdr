...
import "github.com/lesomnus/cdr/ros"
...
var dataset = []struct {
	...
	{
		desc: "sensor_msgs/TwistStamped",
		value: ros.TwistStamped{
			Header: ros.Header{
				Stamp:   ros.Time{Sec: 1, Nsec: 2},
				FrameId: "",
			},
			Twist: ros.Twist{
				Linear: ros.Vector3{
	...
	{
		desc: "sensor_msgs/JointState",
		value: ros.JointState{
			Header: ros.Header{
				Stamp:   ros.Time{Sec: 1, Nsec: 2},
				FrameId: "",
			},
			Name:     []string{"head_1", "head_2"},
			Position: []float64{-1.25, 1.25},
			Velocity: []float64{-0.125, 0.25},
			Effort:   []float64{0.0, 0.0},
		},
		bytes: []byte{
			...
			0x07, 0x00, 0x00, 0x00, // 0x18
			0x68, 0x65, 0x61, 0x64, // 0x1C
			0x5F, 0x31, 0x00, 0x00, // 0x20

			0x07, 0x00, 0x00, 0x00, // 0x24
			0x68, 0x65, 0x61, 0x64, // 0x28
			0x5F, 0x32, 0x00, 0x00, // 0x2C

			// position
			0x02, 0x00, 0x00, 0x00, // 0x30

			0x00, 0x00, 0x00, 0x00, // 0x34
			0x00, 0x00, 0xF4, 0xBF, // 0x38

			0x00, 0x00, 0x00, 0x00, // 0x3C
			0x00, 0x00, 0xF4, 0x3F, // 0x40

			// velocity
			0x02, 0x00, 0x00, 0x00, // 0x44
			0x00, 0x00, 0x00, 0x00, // 0x48

			0x00, 0x00, 0x00, 0x00, // 0x4C
			0x00, 0x00, 0xC0, 0xBF, // 0x50

			0x00, 0x00, 0x00, 0x00, // 0x54
			0x00, 0x00, 0xD0, 0x3F, // 0x58

			// effort
			0x02, 0x00, 0x00, 0x00, // 0x5C
